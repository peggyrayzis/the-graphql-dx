...
<Notes>
  ...
  function of your props plus state. it's immutable so it's consistent. i also
  think the vue community does a really nice job with this one too
  <br />
  <br />
  finally, we have vscode and typescript, which are amazing together giving you instant
  feedback about the code you're writing.
  <br />
  <br />i think another thing these tools all have in common is that they filled
  a void in developer's lives
</Notes>
